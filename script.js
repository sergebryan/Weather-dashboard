...
function searchCity(cityname) {
    ...
    $.ajax({
       ...
       var mainDate = moment().format('L');
        ...
        var cityNameEl = $("<h4>").text(response.name);
...
//--------------------------------------------- UV call ---------------------------------------//
        ...
        var uvlEl = $("<button class='btn bg-success-custom text-white'>").text("UV Index: " + response.value);
...
//--------------------------------------------5 Day frocast call ---------------------------------------//
        ...
        for (var i = 0; i < results.length; i += 8) {
            // Creating a div
        var fiveDayDiv = $("<div class='card shadow-lg text-white bg-primary-custom mx-auto mb-10 p-2' style='width: 8.5rem; height: 11rem;'>");
